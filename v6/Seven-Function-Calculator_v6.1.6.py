"""
SEVEN-FUNCTION CALCULATOR V6.1.6
...
Notes: Updated UI for radicals and trig
...
class Calculate:
    ...
    class Trig:
        ...
        def arcsin(self):
            ...
            print("arcsin({GREEN}{BOLD}___{CLEAR}) ")
        ...
        def arccos(self):
            ...
            print("arccos(GREEN}{BOLD}___{CLEAR}) ")
            print("ENTER VALUE (-1 to 1)\n")
            trigvalue = input().strip().lower()
        ...
        def arctan(self):
            ...
            print("arctan(GREEN}{BOLD}___{CLEAR}) ")
            print("ENTER VALUE (-1 to 1)\n")
            trigvalue = input().strip().lower()
        ...
        def sin(self):
            ...
            print("sin(GREEN}{BOLD}___{CLEAR}) ")
        ...
        def cos(self):
            ...
            print("cos(GREEN}{BOLD}___{CLEAR}) ")
            print("ENTER VALUE (IN DEGREES)\n")
            trigvalue = input().strip().lower()
        ...
        def tan(self):
            ...
            print("tan(GREEN}{BOLD}___{CLEAR}) ")
    ...
    def radical(self):
        ...
        print("{GREEN}{BOLD}____{CLEAR}th root of ____")
        print("ENTER VALUE      ")
        inputs[0] = input()
