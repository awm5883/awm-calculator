...
class Calculate:
    ...
    class Trig:
        ...
        def arcsin(self):
            ...
            print(f"arcsin({GREEN}{BOLD}___{CLEAR}) ")
        ...
        def arccos(self):
            ...
            print(f"arccos({GREEN}{BOLD}___{CLEAR}) ")
            print("ENTER VALUE (-1 to 1)\n")
            trigvalue = input().strip().lower()
        ...
        def arctan(self):
            ...
            print(f"arctan({GREEN}{BOLD}___{CLEAR}) ")
            print("ENTER VALUE (-1 to 1)\n")
            trigvalue = input().strip().lower()
        ...
        def sin(self):
            ...
            print(f"sin({GREEN}{BOLD}___{CLEAR}) ")
        ...
        def cos(self):
            ...
            print(f"cos({GREEN}{BOLD}___{CLEAR}) ")
            print("ENTER VALUE (IN DEGREES)\n")
            trigvalue = input().strip().lower()
        ...
        def tan(self):
            ...
            print(f"tan({GREEN}{BOLD}___{CLEAR}) ")
    ...
    def radical(self):
        ...
        print(f"{GREEN}{BOLD}____{CLEAR}th root of ____")
        print("ENTER VALUE      ")
        inputs[0] = input()
        ...
        print(f"{inputs[0]}{suffix} root of {GREEN}{BOLD}____{CLEAR}")
        print("ENTER VALUE")
        inputs[1] = input()
...
def prompt_restart(first_time): # Perform another calculation message and surrounding computation.
    ...
    if first_time == True:
        ...
        if prompt_restartStr == 'y':
            ...
            print(f"{RED}ERROR: Invalid input recieved when asking to restart{CLEAR}")
            return 1
